    ...
    <div class="flex flex-row w-full bg-white-900">
        ...
        <div class="flex flex-column w-3/12 h-full mt-64 ml-32 bg-[#FAFFFD] shadow-lg border rounded-xl">
            <form class="p-12 font-base">
                ...
                <input type="text" name="otp2" id="opt2" class="border-2 border-[#D0D0D0] rounded-md bg-[#F9F9F9]  w-10 h-10 mx-1 xl:w-14 xl:h-14 xl:mx-2;" />
                <input type="text" name="otp3" id="opt3" class="border-2 border-[#D0D0D0] rounded-md bg-[#F9F9F9]  w-10 h-10 mx-1 xl:w-14 xl:h-14 xl:mx-2;" />
                <input type="text" name="otp4" id="opt4" class="border-2 border-[#D0D0D0] rounded-md bg-[#F9F9F9]  w-10 h-10 mx-1 xl:w-14 xl:h-14 xl:mx-2;" />
                
              
                <p class="font-osans font-bold py-4">00:45</p>
        
                <button class="font-base font-bold text-lg border-2 bg-[#00C285] text-white w-80 h-14 rounded-lg">Login</button>
