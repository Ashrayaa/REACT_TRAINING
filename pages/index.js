  ...
  return (
    <div>
      ...
      <div class="flex flex-col bg-white w-4/5 h-5/6 shadow-xl rounded-lg p-8 m-12 justify-center align-middle items-center">
        ...
        <button type="button" class="text-white bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"><Link href="/card">Survey Form</Link></button>
        <button type="button" class="text-white bg-gradient-to-r from-pink-400 via-cyan-500 to-purple-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"><Link href="/elearninghome">E-learning</Link></button>
        </div>
        </div>
      </main>
    </div>
